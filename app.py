...
if st.button("Count + Compress"):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are an expert at making AI system prompts shorter without losing meaning. Remove filler, redundancy, and over-explanation. Keep all instructions intact."
            },
            {
                "role": "user",
                "content": f"Compress this system prompt:\n\n{system_prompt}"
            }
        ]
    )
